                    ...
                    <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                      ...
                      <div className="mb-2 mt-4 flex items-center">
                        <button
                          ...
                          onClick={() => handleDecreaseCartItem(product.cartId)}
                        >
                          -
                        </button>
                        {/* <input
                        ...
                        /> */}
                        <span className="mx-2 h-7 w-10 rounded-md border text-center">{product.productCount}</span>
                        <button
                          type="button"
                          className="h-7 w-7 bg-gray-200 rounded-full text-gray-600"
                          onClick={() => handleIncreaseCartItem(product.cartId)}
                        >
                          +
                        </button>
                        <button
